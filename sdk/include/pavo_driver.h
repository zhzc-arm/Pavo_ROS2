...
namespace pavo
{
    ...
    private:
        ...
        bool ConfigRegSimp(PAVO_REG_INDEX reg_set, const char* cmd);
        bool ConfigRegDual(PAVO_REG_INDEX reg_set, PAVO_REG_INDEX reg_get, const char* cmd);
